...
class AirrSeriesModel(BaseModel):
    ...
    c_call: Optional[str] = Field(default=None, description="Constant region gene with allele.")  # New in Version 1.4.1
    ...
    cdr1: Optional[str] = Field(default=None, description="Nucleotide sequence of the aligned CDR1 region.")
    cdr1_aa: Optional[str] = Field(default=None, description="Amino acid translation of the cdr1 field.")
    cdr1_end: Optional[int] = Field(default=None, description="CDR1 end position in the query sequence (1-based closed interval).")
    cdr1_start: Optional[int] = Field(default=None,
        description="CDR1 start position in the query sequence (1-based closed interval).",
    )
    cdr2: Optional[str] = Field(default=None, description="Nucleotide sequence of the aligned CDR2 region.")
    cdr2_aa: Optional[str] = Field(default=None, description="Amino acid translation of the cdr2 field.")
    cdr2_end: Optional[int] = Field(default=None, description="CDR2 end position in the query sequence (1-based closed interval).")
    cdr2_start: Optional[int] = Field(default=None,
        description="CDR2 start position in the query sequence (1-based closed interval).",
    )
    cdr3: Optional[str] = Field(default=None, description="Nucleotide sequence of the aligned CDR3 region.")
    cdr3_aa: Optional[str] = Field(default=None, description="Amino acid translation of the cdr3 field.")
    # cdr3_aa_length: Optional[int] = Field(default=None, description="CDR1 end position in the query sequence (1-based closed interval).")
    cdr3_end: Optional[int] = Field(default=None, description="CDR13 end position in the query sequence (1-based closed interval).")
    cdr3_start: Optional[int] = Field(default=None,
        description="CDR3 start position in the query sequence (1-based closed interval).",
    )
    complete_vdj: Optional[bool] = Field(default=None,
    ...
    d_alignment_end: Optional[int] = Field(default=None,
    ...
    d_alignment_start: Optional[int] = Field(default=None,
    ...
    d_call: Optional[str] = Field(default=None,
    ...
    d_cigar: Optional[str] = Field(default=None, description="CIGAR string for the first or only D gene alignment.")
    # d_family: Optional[str] = Field(default=None, description="") CK: Can't find this on https://docs.airr-community.org/en/stable/datarep/rearrangements.html
    d_frame: Optional[bool] = Field(default=None,
    ...
    d_germline_alignment: Optional[str] = Field(default=None,
    ...
    d_identity: Optional[float] = Field(default=None, description="Fractional identity for the first or only D gene alignment.")
    d_score: Optional[float] = Field(default=None, description="Alignment score for the first or only D gene alignment.")
    d_sequence_alignment: Optional[str] = Field(default=None,
    ...
    fwr1: Optional[str] = Field(default=None, description="Nucleotide sequence of the aligned FWR1 region.")
    fwr1_aa: Optional[str] = Field(default=None, description="Amino acid translation of the fwr1 field.")
    fwr1_end: Optional[int] = Field(default=None, description="FWR1 end position in the query sequence (1-based closed interval).")
    fwr1_start: Optional[int] = Field(default=None, description="FWR1 start position in the query sequence (1-based closed interval).")
    fwr2: Optional[str] = Field(default=None, description="Nucleotide sequence of the aligned FWR2 region.")
    fwr2_aa: Optional[str] = Field(default=None, description="Amino acid translation of the fwr2 field.")
    fwr2_end: Optional[int] = Field(default=None, description="FWR2 end position in the query sequence (1-based closed interval).")
    fwr2_start: Optional[int] = Field(default=None,
        description="FWR2 start position in the query sequence (1-based closed interval).",
    )
    fwr3: Optional[str] = Field(default=None, description="Nucleotide sequence of the aligned FWR3 region.")
    fwr3_aa: Optional[str] = Field(default=None, description="Amino acid translation of the fwr3 field.")
    fwr3_end: Optional[int] = Field(default=None, description="FWR3 end position in the query sequence (1-based closed interval).")
    fwr3_start: Optional[int] = Field(default=None,
        description="FWR3 start position in the query sequence (1-based closed interval).",
    )
    fwr4: Optional[str] = Field(default=None, description="Nucleotide sequence of the aligned FWR4 region.")
    fwr4_aa: Optional[str] = Field(default=None, description="Amino acid translation of the fwr4 field.")
    fwr4_end: Optional[int] = Field(default=None, description="FWR4 end position in the query sequence (1-based closed interval).")
    fwr4_start: Optional[int] = Field(default=None,
        description="FWR4 start position in the query sequence (1-based closed interval).",
    )
    germline_alignment: Optional[str] = Field(default=None,
    ...
    germline_alignment_aa: Optional[str] = Field(default=None,
        description="Amino acid translation of the assembled germline sequence.",
    )
    j_alignment_end: Optional[int] = Field(default=None,
    ...
    j_alignment_start: Optional[int] = Field(default=None,
    ...
    j_call: Optional[str] = Field(default=None, description="J gene with allele.")
    j_cigar: Optional[str] = Field(default=None, description="CIGAR string for the J gene alignment.")
    # j_family: Optional[str] = Field(default=None, description=" ") #CK Not found
    j_frameshift: Optional[bool] = Field(default=None,
    ...
    j_germline_alignment: Optional[str] = Field(default=None,
    ...
    j_germline_alignment_aa: Optional[str] = Field(default=None,
        description="Amino acid translation of the j_germline_alignment field.",
    )
    j_germline_end: Optional[int] = Field(default=None,
        description="Alignment end position in the J gene reference sequence (1-based closed interval).",
    )
    j_germline_start: Optional[int] = Field(default=None, description="Alignment start position in the J gene reference sequence (1-based closed interval).")
    j_identity: Optional[float] = Field(default=None, description="Fractional identity for the J gene alignment.")
    j_score: Optional[float] = Field(default=None, description="Alignment score for the J gene alignment.")
    j_sequence_alignment: Optional[str] = Field(default=None,
    ...
    junction: Optional[str] = Field(default=None,
    ...
    junction_aa: Optional[str] = Field(default=None, description="Amino acid translation of the junction.")
    junction_aa_length: Optional[int] = Field(default=None, description="Number of amino acids in the junction sequence.")
    junction_length: Optional[int] = Field(default=None, description="Number of nucleotides in the junction sequence.")
    locus: Optional[str] = Field(default=None,
    ...
    np1: Optional[str] = Field(default=None,
    ...
    np1_length: Optional[int] = Field(default=None,
    ...
    np2: Optional[str] = Field(default=None,
    ...
    np2_length: Optional[int] = Field(default=None,
    ...
    productive: Optional[bool] = Field(default=None, description="True if the V(D)J sequence is predicted to be productive.")
    quality: Optional[str] = Field(default=None,
        description="The Sanger/Phred quality scores for assessment of sequence quality.",
    )  # CK Added in 1.4.1
    quality_alignment: Optional[str] = Field(default=None,
        description="Sanger/Phred quality scores for assessment of sequence_alignment quality.",
    )  # CK Added in 1.4.1
    rev_comp: Optional[bool] = Field(default=None,
        description="True if the alignment is on the opposite strand (reverse complemented) with respect to the query sequence.",
    )
    sequence: Optional[str] = Field(default=None, description="The query nucleotide sequence.")
    sequence_alignment: Optional[str] = Field(default=None,
    ...
    sequence_alignment_aa: Optional[str] = Field(default=None, description="Amino acid translation of the aligned query sequence.")
    stop_codon: Optional[bool] = Field(default=None, description="True if the aligned sequence contains a stop codon.")
    v_alignment_end: Optional[int] = Field(default=None,
    ...
    v_alignment_start: Optional[int] = Field(default=None,
    ...
    v_call: Optional[str] = Field(default=None,
    ...
    v_cigar: Optional[str] = Field(default=None, description="CIGAR string for the V gene alignment.")
    # v_family: Optional[str] = Field(default=None, description=" ")
    v_frameshift: Optional[bool] = Field(default=None,
    ...
    v_germline_alignment: Optional[str] = Field(default=None,
    ...
    v_germline_alignment_aa: Optional[str] = Field(default=None,
        description="Amino acid translation of the v_germline_alignment field.",
    )
    v_germline_end: Optional[int] = Field(default=None,
        description="Alignment end position in the V gene reference sequence (1-based closed interval).",
    )
    v_germline_start: Optional[int] = Field(default=None,
        description="Alignment start position in the V gene reference sequence (1-based closed interval).",
    )
    v_identity: Optional[float] = Field(default=None, description="Fractional identity for the V gene alignment.")
    v_score: Optional[float] = Field(default=None, description="Alignment score for the V gene.")
    v_sequence_alignment: Optional[str] = Field(default=None,
    ...
    vj_in_frame: Optional[bool] = Field(default=None, description="True if the V and J gene alignments are in-frame.")
    # chain: Optional[str] = Field(default=None, description=" ")
    species: Optional[str] = Field(default=None, description="Species")  # CK missing on https://docs.airr-community.org/en/stable/datarep/rearrangements.html
